...
const EventEntitySchema = new Schema({
  type: {
    type: String,
    enum: ['product', 'seller', 'post', 'review', 'search', 'ad', 'category'] as EventEntityType[],
    required: true
  },
  id: {
...
export const UserEvent = (mongoose.models.UserEvent as Model<IUserEventDocument>) || 
...
export interface IUserProfileAIDocument extends Omit<IUserProfileAI, '_id'>, Document {}
...
export const UserProfileAI = (mongoose.models.UserProfileAI as Model<IUserProfileAIDocument>) ||
...
export interface IAdImpressionDocument extends Omit<IAdImpression, '_id'>, Document {}
...
export const AdImpression = (mongoose.models.AdImpression as Model<IAdImpressionDocument>) ||
...
export const AdClick = (mongoose.models.AdClick as Model<IAdClickDocument>) ||
...
export interface IChatbotSessionDocument extends Omit<IChatbotSession, '_id'>, Document {}
...
ChatbotSessionSchema.index({ updatedAt: 1 }, { expireAfterSeconds: 24 * 60 * 60 });  // 24 hours

export const ChatbotSession = (mongoose.models.ChatbotSession as Model<IChatbotSessionDocument>) ||
  mongoose.model<IChatbotSessionDocument>('ChatbotSession', ChatbotSessionSchema);

// ============================================
// FRAUD SIGNALS SCHEMA (Part 11)
// ============================================

export interface IFraudSignalDocument extends Omit<IFraudSignal, '_id'>, Document {}

const FraudSignalSchema = new Schema<IFraudSignalDocument>({
  type: {
    type: String,
    enum: ['fake_review', 'dispute_abuse', 'seller_fraud', 'account_takeover'],
    required: true,
    index: true
  },
  severity: {
...
export const FraudSignal = (mongoose.models.FraudSignal as Model<IFraudSignalDocument>) ||
...
export const ProductEmbedding = (mongoose.models.ProductEmbedding as Model<IProductEmbeddingDocument>) ||
  mongoose.model<IProductEmbeddingDocument>('ProductEmbedding', ProductEmbeddingSchema);
