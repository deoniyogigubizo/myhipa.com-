...
// Location index
GroupSchema.index({ 'location.city': 1, 'location.country': 1 }, { name: 'location_idx' });
 ...
 * Remove moderator
 */
GroupSchema.methods.removeModerator = function(userId: mongoose.Types.ObjectId) {
 ...
 */
GroupSchema.methods.isModerator = function(userId: mongoose.Types.ObjectId): boolean {
