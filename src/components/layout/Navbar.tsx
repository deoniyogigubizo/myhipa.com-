            ...
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-gray-400 -mt-0.5 tracking-wide lowercase">
            ...
            <div className="flex items-center gap-6">
              ...
              {isAuthenticated ? (
                ...
                >
                  <Link
                    href="/cart"
                    className="flex items-center bg-gray-800/80 border border-gray-700/50 rounded-full px-4 py-2 backdrop-blur-sm hover:bg-gray-700/80 transition-colors"
                  >
                      ...
                      <div className="max-h-64 overflow-y-auto">
                        {items.slice(0, 3).map((item) => (
                          <div
                            ...
                            className="p-3 border-b border-gray-100 flex items-center gap-3 hover:bg-gray-50"
                          >
          ...
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="hidden md:flex items-center gap-6">
                <Link
                  href="/search"
                  className="text-gray-700 hover:text-amber-600 font-medium text-sm transition-colors"
                >
                  Find Products
                </Link>
                <Link
